...
import { FiPhoneCall } from 'react-icons/fi'; // React Icons for the call icon
...
const Home = () => {
  return (
    ...
    <div className="all">
          ...
          <Row>
            <Col lg="6">
              <div className="hero__content">
                ...
                <h1>
                  Athithidevo Bhava!
                  <span className="highlight">अतिथिदेवो भव!</span>
                </h1>
                <p>
      ...
      {/* car tabbing secction start*/}
      <Tabs/>
      {/* car tabbing secction end */}
            ...
            <Col lg="6">
              <div className="experience__content">
                ...
                <p>
                  ...
                  <br />
                  Drawing from our extensive experience.
                </p>
              </div>
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              <h5 className="services__subtitle">Customer's Love</h5>
      ...
      <Newsletter />
      <div
        className="fixed-bottom d-flex justify-content-start mb-3  "
        style={{ zIndex: 1050 }}
      >
        <a
          href="tel:+91 123456789"
          className="btn btn-success rounded-circle p-3 shadow ms-2"
          style={{
            display: "flex",
            alignItems: "center",
