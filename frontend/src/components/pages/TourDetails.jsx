  ...
  <Form onSubmit={submitHandler}>
    <div className="d-flex align-items-center gap-3 mb-4 rating__group">
      ...
      <span 
        ...
        className={tourRating >= 1 ? "filled-star" : ""}
      >
      ...
      <span 
        ...
        className={tourRating >= 2 ? "filled-star" : ""}
      >
        <i class="ri-star-s-fill"></i>
      </span>
      3 
      <span 
        ...
        className={tourRating >= 3 ? "filled-star" : ""}
      >
        <i class="ri-star-s-fill"></i>
      </span>
      4 
      <span 
        ...
        className={tourRating >= 4 ? "filled-star" : ""}
      >
        <i class="ri-star-s-fill"></i>
      </span>
      5 
      <span 
        ...
        className={tourRating >= 5 ? "filled-star" : ""}
      >
        <i class="ri-star-s-fill"></i>
      </span>
    </div>
